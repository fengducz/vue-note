...
<div class="col-md-3" id="note-list">
    ...
    <div class="btn-group  btn-group-justified  ">
        <div class="btn-group btn-group-lg">
            <button type="button" class=" btn btn-default" @click="showAll('all')" :class="{active: show === 'all'}" name="button">全部</button>
        </div>
        <div class="btn-group btn-group-lg">
            <button type="button" class=" btn btn-default" @click="showAll('favorite')" :class="{active: show === 'favorites'}" name="button">最爱</button>
        </div>
    </div>
